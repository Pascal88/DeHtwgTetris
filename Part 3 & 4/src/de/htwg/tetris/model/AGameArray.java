...
public abstract class AGameArray extends ASubject implements IGameArray{
	 ...
	 */
	public abstract boolean arrayStateOfElementPosition(Element el, states z);
	 ...
	 */
	public abstract boolean arrayElementInArray(Element el);
	 ...
	 */
	public abstract boolean arrayElementInLeft(Element el);
	 ...
	 * 		if the element is in the array
	 */
	public abstract boolean arrayElementInRight(Element el);
	 ...
	 * 		if the element is in the array
	 */
	public abstract boolean arrayElementInDown(Element el);
	
	public abstract void elementMergeArray(Element el);
