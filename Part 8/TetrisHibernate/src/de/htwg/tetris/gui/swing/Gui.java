...
public class Gui extends JFrame 
{
	...
	public Gui(NewGameListener newGameListener,	TetrisKeyListener keyListener, IGameController gameController, SaveGameListener saveGameListener, LoadGameListener loadGameListener) 
	{
		super("Tetris");
		...
		this.gameField = new GameField(gameController.getSpielarray());
