...
public class Tetris 
{
	...
	private MechanikController mechanikController;
	...
	public Tetris() {
		...
		/* init controller*/
		tetrisController = new TetrisController(spielarray);
		mechanikController = new MechanikController(tetrisController, moveDown);
		observersNewElement.add(mechanikController);
	
		/* init Listener */
		keyListener = new TetrisKeyListener(tetrisController, moveDown, moveLeft, moveRight, moveUp);
		newGameListener = new NewGameListener(spielarray, tetrisController, mechanikController);
