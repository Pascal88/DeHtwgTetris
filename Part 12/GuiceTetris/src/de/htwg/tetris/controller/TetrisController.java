...
import de.htwg.tetris.gui.GuiFactory;
import de.htwg.tetris.gui.GuiModule;
...
import de.htwg.tetris.model.db.DbFactory;
import de.htwg.tetris.model.db.DbModule;
...
public class TetrisController implements ITetrisController {
	...
	private Injector injectorDB = null;
	private Injector injectorGUI = null;
	...
	public TetrisController(IGameController gameController, IMechanikController mechanikController) {
		...
		//Depency Injection
		this.injectorDB = Guice.createInjector(new DbModule());
		this.injectorGUI = Guice.createInjector(new GuiModule());
		
		this.db = injectorDB.getInstance(DbFactory.class);
		
		frame = injectorGUI.getInstance(GuiFactory.class);
